...
if __name__ == '__main__':
    ...
    TARGET_CONTRACT = 'FG405' # 这是一个示例, 请根据您的文件名和数据内容进行修改

    # 2. 定义文件路径
    SOURCE_OPTIONS_FILE = 'ETL\data\\FG_option_data_2024.csv'
    
    # 这个文件必须是已存在的、格式化后的期货数据
    FUTURES_DATA_FILE = 'Protected_Futures_Reverse_Grid_Strategy/data/FG2405/futures_data.csv' 
    
    # 这是最终生成的、可用于回测的期权数据文件
    OUTPUT_OPTIONS_FILE = 'Protected_Futures_Reverse_Grid_Strategy/data/FG2405/options_data.csv'
